...
- Use the repository root as the Cloudflare one-click deployment target with minimal `wrangler.toml`, Cloudflare template metadata, build/deploy command prefills, open-by-default auth mode, and optional bearer-token hardening.
