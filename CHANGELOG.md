...
- Replace the Cloudflare one-click path with true zero-config deployment: `wrangler.toml`, Cloudflare template metadata, build/deploy command prefills, open-by-default auth mode, and optional bearer-token hardening.
